...
public abstract class ClassFactory {
  ...
  public static be.valuya.winbooks._Compte createCompte() {
    return COM4J.createInstance( be.valuya.winbooks._Compte.class, "{48F3777C-6A93-49E9-8356-F0A6D20FB28A}" );
  }

  public static be.valuya.winbooks._TableUser createTableUser() {
    return COM4J.createInstance( be.valuya.winbooks._TableUser.class, "{C2C9C138-51C3-4BB4-9F43-4C5006B23644}" );
  }
  ...
  public static be.valuya.winbooks._AnaLytique createAnaLytique() {
    return COM4J.createInstance( be.valuya.winbooks._AnaLytique.class, "{6A32FF54-31A4-4A29-BBAC-484B0E3F5D74}" );
  }
  ...
  public static be.valuya.winbooks._WinbooksObject createWinbooksObject() {
    return COM4J.createInstance( be.valuya.winbooks._WinbooksObject.class, "{B67F206D-2887-4898-89D8-8AD5691B6DF0}" );
  }

  public static be.valuya.winbooks._SqlClass createSqlClass() {
    return COM4J.createInstance( be.valuya.winbooks._SqlClass.class, "{CEA217D2-2E26-4E20-A7E4-094A55E3C421}" );
  }
  ...
  public static be.valuya.winbooks._Analytiques createAnalytiques() {
    return COM4J.createInstance( be.valuya.winbooks._Analytiques.class, "{EDC584A4-AB62-4BAB-94CF-13BC7D350961}" );
  }

  public static be.valuya.winbooks._Transaction createTransaction() {
    return COM4J.createInstance( be.valuya.winbooks._Transaction.class, "{DCCB2DE6-FA2A-430D-A79D-F79B258FF15A}" );
  }
}
