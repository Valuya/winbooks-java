...
@IID("{A6088639-11A0-4822-A0C4-B737DD01B13D}")
public interface _WinbooksObject extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  be.valuya.winbooks._Compte customers(
  ...
  @VTID(10)
  @ReturnValue(defaultPropertyThrough={be.valuya.winbooks._Comptes.class})
  be.valuya.winbooks._Compte suppliers(
    java.lang.String range);
  ...
  @VTID(13)
  @ReturnValue(defaultPropertyThrough={be.valuya.winbooks._Comptes.class})
  be.valuya.winbooks._Compte accounts(
    java.lang.String range);
  ...
  be.valuya.winbooks._Transaction customerTrans(
    java.lang.String range);
  ...
  @VTID(22)
  be.valuya.winbooks._Transaction custTrans();
   ...
   * </p>
   * @param custTrans Mandatory be.valuya.winbooks._Transaction parameter.
   */
  ...
  @VTID(25)
  @ReturnValue(defaultPropertyThrough={be.valuya.winbooks._Transactions.class})
  be.valuya.winbooks._Transaction supplierTrans(
    java.lang.String range);
  ...
  @VTID(28)
  @ReturnValue(defaultPropertyThrough={be.valuya.winbooks._Transactions.class})
  be.valuya.winbooks._Transaction accountTrans(
    java.lang.String range);
   ...
   * </p>
   * @return  Returns a value of type be.valuya.winbooks._Analytiques
   */

  @DISPID(1073938440) //= 0x40030008. The runtime will prefer the VTID if present
  @VTID(31)
  be.valuya.winbooks._Analytiques analyticalTrans();
   ...
   * </p>
   * @param analyticalTrans Mandatory be.valuya.winbooks._Analytiques parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type be.valuya.winbooks._SqlClass
   */

  @DISPID(1073938445) //= 0x4003000d. The runtime will prefer the VTID if present
  @VTID(46)
  be.valuya.winbooks._SqlClass sql();
   ...
   * </p>
   * @param sql Mandatory be.valuya.winbooks._SqlClass parameter.
   */
