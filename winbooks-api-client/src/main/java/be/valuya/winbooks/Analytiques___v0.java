...
public interface Analytiques___v0 extends Com4jObject {
   ...
   * @return  Returns a value of type be.valuya.winbooks.AnaLytique___v0
   */

  @DISPID(1610809349) //= 0x60030005. The runtime will prefer the VTID if present
  @VTID(10)
  be.valuya.winbooks.AnaLytique___v0 item(
  ...
  @VTID(15)
  be.valuya.winbooks.AnaLytique___v0 wichplan(
    short strindex);
  ...
  @VTID(16)
  be.valuya.winbooks.AnaLytique___v0 wichSectionPlan(
  ...
  @VTID(25)
  void exportListeOfAnalyticalPlan2(
    short sectionAna,
    @Optional Holder<java.lang.String> startAccount,
    @Optional Holder<java.lang.String> endAccount,
    @Optional Holder<java.lang.String> category,
