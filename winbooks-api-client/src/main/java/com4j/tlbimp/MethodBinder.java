...
import static com4j.NativeType.BSTR_ByRef;
import static com4j.NativeType.Bool;
import static com4j.NativeType.CSTR;
import static com4j.NativeType.Double;
import static com4j.NativeType.Double_ByRef;
import static com4j.NativeType.Float;
import static com4j.NativeType.Float_ByRef;
import static com4j.NativeType.Int16;
import static com4j.NativeType.Int16_ByRef;
import static com4j.NativeType.Int32;
import static com4j.NativeType.Int32_ByRef;
import static com4j.NativeType.Int64;
import static com4j.NativeType.Int64_ByRef;
import static com4j.NativeType.Int8;
import static com4j.NativeType.Int8_ByRef;
import static com4j.NativeType.Unicode;
import static com4j.NativeType.VARIANT;
import static com4j.NativeType.VARIANT_ByRef;
import static com4j.NativeType.VariantBool;
import static com4j.NativeType.VariantBool_ByRef;
import com4j.Variant;
import static com4j.tlbimp.MethodBinder.isEnum;
...
import static com4j.tlbimp.def.InvokeKind.PROPERTYGET;
import static com4j.tlbimp.def.InvokeKind.PROPERTYPUT;
import static com4j.tlbimp.def.InvokeKind.PROPERTYPUTREF;
...
abstract class MethodBinder
{
  ...
  private int getReturnParam() {
    ...
    public void declare(IndentingWriter o) throws BindingException {
        MethodBinder.Parameter[] defaultParams = generateDefaults();
  ...
  private MethodBinder.Parameter[] generateDefaults(){
    MethodBinder.Parameter[] defParam = new MethodBinder.Parameter[params.length];
    for (int i = 0; i < params.length; i++) {
      if(params[i].isOptional()){
        ...
        defParam[i] = new MethodBinder.Parameter();
  ...
  private void declareJavaDoc(IndentingWriter o, MethodBinder.Parameter[] defaultParam, boolean[] useDefault){
    // JavaDoc
    o.beginJavaDocMode();
    ...
    for(int i = 0; i < params.length; i++){
      ...
      if (p.isOptional()) {
        ...
        if (defaultParam[i] != null && defaultParam[i].javaCode != null) {
  ...
  private void declareWithDefaults(IndentingWriter o, MethodBinder.Parameter[] defaultParam, boolean[] useDefault) throws BindingException {
